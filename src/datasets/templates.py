...
fer2013_template = [
    lambda c: f'a photo of a {c} face.',
    lambda c: f'a photo of a person with a {c} facial expression.',
    lambda c: f'a face showing {c} emotion.',
]
...
oxford_pets_template = [
    ...
    lambda c: f'a photo of the {c}, a type of pet.',
    lambda c: f'a close-up photo of a {c}.',
]

pcam_template = [
    lambda c: f'a histopathology image of {c} tissue.',
    lambda c: f'a pathology patch showing {c}.',
    lambda c: f'a microscope image of {c}.',
]
...
dataset_to_template = {
    ...
    'OxfordIIITPet': oxford_pets_template,
    'OxfordPets': oxford_pets_template,
    'PCAM': pcam_template,
...
# Return the corresponding template for zero-shot prompt
